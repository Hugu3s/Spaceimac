...
int main(int argc, char** argv) {
    ...
    glm::mat4 NormalMatrix = glm::mat4(1)/*glm::transpose(glm::inverse(MVMatrix))*/;
    ...
    std::unique_ptr<Image> EarthMap=loadImage("D:\\marco\\Desktop\\IMAC2\\OpenGl\\SpaceIMAC(master)\\asset\\textures\\EarthMap.jpg");
    std::unique_ptr<Image> MoonMap=loadImage("D:\\marco\\Desktop\\IMAC2\\OpenGl\\SpaceIMAC(master)\\asset\\textures\\MoonMap.jpg");
    std::unique_ptr<Image> CloudMap=loadImage("D:\\marco\\Desktop\\IMAC2\\OpenGl\\SpaceIMAC(master)\\asset\\textures\\CloudMap.jpg");
